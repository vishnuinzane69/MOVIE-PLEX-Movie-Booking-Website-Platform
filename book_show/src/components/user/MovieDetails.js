          ...
          <div className="col-md-4">
            <div className="card" style={{ minHeight: '200px' }}>
              ...
              <div className="card-body">
                ...
                />
                <Link
                  to={`/BookingForm/${movie.id}/${encodeURIComponent(movie.title)}`} className="btn btn-warning mb-3" style={{ backgroundColor: '#FFD700', borderColor: '#FFD700', color: 'black', marginRight: '10px' }}>
                  Book Tickets
                </Link>
              </div>
            </div>
